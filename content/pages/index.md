...
sections:
  ...
  - type: GenericSection
    ...
    motion: fade-down
    title: { text: Accelerate Growth With Aurrus., type: TitleBlock }
    ...
    actions:
      - { label: Get started, url: /, icon: arrowRight, iconPosition: right, style: secondary, type: Button }
    media:
      url: /images/main-hero-new.png
      altText: Aurrus Consulting Hero
      type: ImageBlock
      styles:
        self: { width: w-[280px] sm:w-[340px] md:w-[400px] lg:w-[440px], height: h-auto, objectFit: object-contain }
    badge: { label: Smarter workflows. Stronger results., color: text-primary, type: Badge }
    colors: bg-light-fg-dark
    styles:
      self: { alignItems: center, flexDirection: row, padding: [pt-12, pb-12, pl-16, pr-16] }
      title: { className: text-4xl sm:text-5xl font-extrabold tracking-tight text-dark transition-transform duration-300 hover:scale-105 }

  # ───────── WHY AURRUS ─────────
  - type: FeaturedItemsSection
    __metadata: { modelName: FeaturedItemsSection }
    motion: fade-up
    title: { text: Why Aurrus?, type: TitleBlock }
    items:
      - type: FeaturedItem
        ...
        image: { url: /images/icon1.png, altText: Strategy icon, type: ImageBlock }
      ...
      - type: FeaturedItem
        ...
        image: { url: /images/icon2.png, altText: OD icon, type: ImageBlock }
        colors: bg-neutralAlt-fg-dark
        styles:
          self: { padding: [p-8], borderRadius: x-large, flexDirection: row, textAlign: left }
          subtitle: { className: text-xl font-bold text-dark }
      ...
      - type: FeaturedItem
        ...
        image: { url: /images/icon3.png, altText: Advisory icon, type: ImageBlock }
        colors: bg-neutralAlt-fg-dark
        styles:
          self: { padding: [p-8], borderRadius: x-large, flexDirection: row }
          subtitle: { className: text-xl font-bold text-dark }
    ...
    styles:
      self: { padding: [pt-12, pb-12, pl-16, pr-16] }
      title: { className: text-3xl sm:text-4xl font-extrabold tracking-tight text-dark transition-transform duration-300 hover:scale-105 }
      subtitle: { className: text-xl font-bold text-dark transition duration-300 ease-in-out hover:text-[#f97316] }

  # ───────── DIVIDER (thin) ─────────
  - type: DividerSection
    __metadata: { modelName: DividerSection }
    colors: bg-light-fg-dark
    styles: { self: { padding: [pt-3, pb-3] } }

  # ───────── BUILT FOR IMPACT ─────────
  - type: GenericSection
    __metadata: { modelName: GenericSection }
    motion: fade-right
    title: { text: Built for Impact., type: TitleBlock }
    text: >
    ...
    media:
      ...
      type: ImageBlock
      styles:
        self: { width: w-full, height: h-auto, maxHeight: max-h-[400px], objectFit: object-contain }
    badge: { label: Key Benefits, color: text-primary, type: Badge }
    colors: bg-light-fg-dark
    styles:
      self: { flexDirection: row, alignItems: center, padding: [pt-8, pb-8, pl-8, pr-8] }
      title: { className: text-3xl sm:text-4xl font-extrabold tracking-tight text-dark transition-transform duration-300 hover:scale-105 }
  ...
  - type: GenericSection
    __metadata: { modelName: GenericSection }
    motion: fade-left
    title: { text: Collaborative with Design, type: TitleBlock }
  ...
  - type: GenericSection
    __metadata: { modelName: GenericSection }
    motion: fade-right
    title: { text: Talent Acquisition & Training, type: TitleBlock }
    ...
    media: { url: /images/hero2.png, altText: Talent illustration, type: ImageBlock }
    badge: { label: People‑Centric Solutions, color: text-primary, type: Badge }
    colors: bg-light-fg-dark
    styles:
      self: { alignItems: center, flexDirection: row, padding: [pt-12, pb-12, pl-8, pr-8] }
      title: { className: text-3xl sm:text-4xl font-extrabold tracking-tight text-dark transition-transform duration-300 hover:scale-105 }
      subtitle: { className: text-xl font-bold text-dark }
  ...
  - type: GenericSection
    __metadata: { modelName: GenericSection }
    motion: fade-left
    title: { text: Outsourcing & Transformation, type: TitleBlock }
    ...
    media: { url: /images/hero3.png, altText: Transformation illustration, type: ImageBlock }
    badge: { label: BPO/KPO Expertise, color: text-primary, type: Badge }
    colors: bg-light-fg-dark
    styles:
      self: { flexDirection: row-reverse, alignItems: center, padding: [pt-12, pb-12, pl-8, pr-8] }
      title: { className: text-3xl sm:text-4xl font-extrabold tracking-tight text-dark transition-transform duration-300 hover:scale-105 }
      subtitle: { className: text-xl font-bold text-dark }
  ...
  - type: FeaturedItemsSection
    __metadata: { modelName: FeaturedItemsSection }
    motion: fade-up
    title: { text: The Aurrus Difference, type: TitleBlock }
    ...
    items:
      - type: FeaturedItem
        ...
        image: { url: /images/collab.png, altText: Colab icon, type: ImageBlock }
        colors: bg-light-fg-dark
        styles:
          self: { padding: [p-8], borderRadius: x-large, flexDirection: col md:row }
          subtitle: { className: text-xl font-bold text-dark }
      ...
      - type: FeaturedItem
        ...
        image: { url: /images/execution.png, altText: Execution icon, type: ImageBlock }
        colors: bg-light-fg-dark
        styles:
          self: { padding: [p-8], borderRadius: x-large, flexDirection: col md:row }
          subtitle: { className: text-xl font-bold text-dark }
      ...
      - type: FeaturedItem
        ...
        image: { url: /images/experience.png, altText: Experience icon, type: ImageBlock }
        colors: bg-light-fg-dark
        styles:
          self: { padding: [p-8], borderRadius: x-large, flexDirection: col md:row }
          subtitle: { className: text-xl font-bold text-dark }
    ...
    colors: bg-neutral-fg-dark
    styles:
      self: { padding: [pt-12, pb-12, pl-8, pr-8] }
      title: { className: text-3xl sm:text-4xl font-extrabold tracking-tight text-primary transition-transform duration-300 hover:scale-105 }
      subtitle: { className: text-xl font-bold text-dark transition duration-300 ease-in-out hover:text-[#f97316] }

  # ───────── CTA / FORM ─────────
  - type: RawHtmlBlock
    __metadata: { modelName: RawHtmlBlock }
    motion: fade-down
    colors: bg-light-fg-dark
    styles:
      self: { padding: [pt-12, pb-12, pl-8, pr-8], textAlign: center }
    html: |
        ...
        <form action="https://formsubmit.co/contact.aurrus@gmail.com" method="POST" class="mt-10 space-y-5 text-left">
          ...
          <div>
           ...
           <div>
             ...
             <select name="purpose" id="purpose" required class="w-full p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#f97316] focus:outline-none">
